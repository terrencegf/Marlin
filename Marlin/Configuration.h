...
#define THINKERV2_BLTOUCH  // Enable for an installed BLTOUCH TGF - orig disabled
...
#define STRING_CONFIG_H_AUTHOR "(terrencegf, THINKER SE config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kd_LIST {  61.71,  61.71 }
  #else
    #define DEFAULT_Kp  23.72  // TGF - orig 22.20
    #define DEFAULT_Ki   2.28  //             1.08
    #define DEFAULT_Kd  61.71  //           114.00
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 100.00  // TGF - mine was 10.00
  #define DEFAULT_bedKi 5.023   //                 0.023
 ...
 */
//#define X_DRIVER_TYPE  A4988   // TGF - mine was TMC2208_STANDALONE for X, Y, Z, Z2, E0
 ...
 */
//#define CLASSIC_JERK     // TGF - orig uncommented
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013 // (mm) Distance from real junction edge  TGF - mine was 0.008
 ...
 */
#define S_CURVE_ACCELERATION // TGF - orig disabled
...
#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping TGF - mine was -3
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // TGF - orig disabled
 ...
 */
//#define NUM_SERVOS 1 // Servo index starts with 0 for M280 command  TGF - mine was 1
